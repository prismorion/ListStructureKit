...
{
    [TestFixture]
    public class DoublyLinkedListLSKTests
    {
        [Test]
        public void AddFirst_AddsElementToFrontOfList()
        {
            var list = new DoublyLinkedListLSK<int>();
            list.AddFirst(1);
            list.AddFirst(2);
            list.AddFirst(3);
        ...
        {
            var list = new DoublyLinkedListLSK<int>(1, 2, 4);
            list.AddBefore(4, 3);
        ...
        {
            var list = new DoublyLinkedListLSK<char>('a', 'b', 'c');
        ...
        {
            var list = new DoublyLinkedListLSK<int>(1, 2, 3, 2, 4);
        ...
        {
            var list = new DoublyLinkedListLSK<double>(1.1, 2.2, 3.3);
        ...
        {
            var list1 = new DoublyLinkedListLSK<int>(1, 2, 3);
            var list2 = new DoublyLinkedListLSK<int>(4, 5, 6);

            var concatenatedList = DoublyLinkedListLSK<int>.Concat(list1, list2);
        ...
        {
            var list = new DoublyLinkedListLSK<string>("apple", "banana", "cherry");
        ...
        {
            var list = new DoublyLinkedListLSK<int>(1, 2, 3);
        ...
        public void Deserialization_DeserializesListFromJsonFile()
        {
            ...
            var deserializedList = DoublyLinkedListLSK<string>.Deserialization(filePath);
        ...
        public void Deserialization_ThrowsException_WhenFileDoesNotExist()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => DoublyLinkedListLSK<int>.Deserialization(filePath), "Отсутствует файл по указанному пути.");
        }
        ...
        public void Deserialization_ThrowsException_WhenFileIsNotJson()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => DoublyLinkedListLSK<int>.Deserialization(filePath), "Файл должен быть JSON.");
